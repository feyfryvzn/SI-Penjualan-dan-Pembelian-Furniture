...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 15, 2025 at 05:32 AM
...
('11111', 'KURSI', '100000000'),
('123123', 'MEJA\r\n', '1000000'),
('12312312', 'LEMARI', '1000000');
...
('00000', 'ica cantik', 'gang g', '1212121212'),
('P002', 'feyza', 'poncol raya', '098765432123'),
...
INSERT INTO `detail_bahanbaku` (`id_kayu`, `id_barang`, `unit`, `takaran`) VALUES
('KA001', '123123', 'kg', 'BUBUB'),
('KA001', '12312312', 'GRAM', 'APA AJA'),
('KA002', '11111', 'kg', 'bubub');
...
--
-- Dumping data for table `detail_hasil_hutan`
--

INSERT INTO `detail_hasil_hutan` (`no_dkb`, `no_urut`, `id_kayu`, `tanggal`, `volume`, `panjang`, `diameter`, `keterangan`) VALUES
('004/BYH/X/2011', 1, 'KA001', '2025-06-03', 0.00, 200.00, 16.00, 'MAMA');
...
INSERT INTO `detail_penjualan` (`no_nota`, `id_barang`, `banyaknya`, `jumlah`) VALUES
('DDDD', '123123', 6, '6000000'),
('3456543', '11111', 3, '300000000'),
('333333333333333', '12312312', 45, '45000000');
...
--
-- Dumping data for table `dokumenpkb`
--

INSERT INTO `dokumenpkb` (`no_dkb`, `id_pemilik`, `id_pemeriksa`, `tanggal_pembuatan`, `tempat_muat`, `no_skkk`, `jumlah_batang`, `volume_total`, `id_kelurahan`) VALUES
('004/BYH/X/2011', 'LI001', 'SA01', '2025-06-14', 'PONCOL RAYA', '1518570', 70, '4.579', 360226201),
('88', 'LI001', 'SA01', '2025-06-15', 'tuy', 'kjsdnio39', 1, '89', 317202101);
...
--
-- Dumping data for table `jenis_hasil_hutan`
--

INSERT INTO `jenis_hasil_hutan` (`id_kayu`, `jenis_hasil_hutan`) VALUES
('KA001', 'JATI'),
('KA002', 'MAHONI'),
('KA003', 'MERANTI'),
('KA004', 'TREMBESI'),
...
INSERT INTO `penjualan` (`no_nota`, `id_customer`, `id_pegawai`, `tanggal`, `jumlah_Rp`, `DP`, `sisa`) VALUES
('333333333333333', 'P002', 'PE001', '2025-02-14', '0', '60000', '-60000'),
('3456543', 'P002', 'PE001', '2025-06-04', '25000', '5000', '-5000'),
('DDDD', 'P003', 'PEM001', '2025-06-05', '56000', '2000.00', '-2000.00');
