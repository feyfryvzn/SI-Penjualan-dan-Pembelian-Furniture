...
if (isset($_POST['proses'])) {
    if ($conn) {
        ...
        if ($stmt) {
            $stmt->bind_param("s", $id_barang);
            if ($stmt->execute()) {
                header("Location: barang-lihat.php?success=delete");
                exit();
            } else {
...
<body>
  ...
  <div class="main">
    <div class="dashboard-header">
      <div>
        <h2 class="text-dark font-weight-bold mb-0">Hapus Barang</h2>
        <small class="text-muted">15 Juni 2025, 12:06 AM WIB</small>
      </div>
      <img src="../images/kop.jpg" alt="Logo" height="40">
    </div>

    <div class="card">
      <h5 class="mb-4 text-center">Konfirmasi Hapus Barang</h5>
      <?php if (isset($error)): ?>
      ...
      <div class="form-group">
        ...
        <input type="text" class="form-control" value="<?php echo htmlspecialchars($data['id_barang']); ?>" readonly>
      </div>
      <div class="form-group">
      ...
      <div class="form-group">
        ...
        <input type="text" class="form-control" value="Rp <?php echo number_format($data['harga_satuan'], 0, ',', '.'); ?>" readonly>
      </div>
